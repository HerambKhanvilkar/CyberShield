...
const DOCUMENTS = [
    ...
    { id: 3, name: "Completion Letter", preview: "Fellowship Accreditation & Badges" }
];
        ...
        <div className="min-h-screen bg-[#020205] text-white">
            ...
            <section className="py-20 bg-white/[0.02] border-y border-white/5 overflow-hidden">
                <div className="max-w-7xl mx-auto px-4">
                    <h2 className="text-sm font-bold text-gray-500 uppercase tracking-[0.3em] mb-12 text-center">Fellowship Credentials</h2>
