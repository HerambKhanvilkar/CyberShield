            ...
            children: [
              ...
              const Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Motorola Edge 50 Fusion', style: TextStyle(color: Color(0xFFC6FF00), fontWeight: FontWeight.bold, fontSize: 16)),
                    ...
                    SizedBox(height: 4),
                    Text('Uptime: 4d 5h 54m 32s', style: TextStyle(color: Colors.grey, fontSize: 11)),
                  ],
                ),
              ),
