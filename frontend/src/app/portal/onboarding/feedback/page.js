    ...
    const renderStep = () => {
        switch (step) {
                    ...
                    <div className="space-y-6">
                        <div className="p-4 bg-cyan-900/10 border border-cyan-500/20 rounded-xl mb-6">
                            ...
                            <p className="text-sm text-gray-400">
                                The DeepCytes Fellowship Program (DCFP) is more than just a fellowship—it’s a movement uniting passionate minds from across the world to tackle the most pressing challenges in cybersecurity.
                            </p>
                        </div>
            ...
            case 2: // Plans
                return (
                    <div className="space-y-6">
                        <h3 className="text-lg font-bold text-white">Your Plans with DCFP</h3>
                        <p className="text-sm text-gray-500">Are you planning to continue with the DeepCytes Fellowship Program for the next phase?</p>
                ...
                return (
                    <div className="space-y-6 h-96 overflow-y-auto custom-scrollbar pr-2">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs text-gray-400 uppercase">Skill Level BEFORE Fellowship (1-5)</label>
